...
class Ui_framePrincipal(object):
    def setupUi(self, framePrincipal):
        ...
        self.Eliminar = QtWidgets.QPushButton(self.groupBoxConfiguracion)
        self.Eliminar.setGeometry(QtCore.QRect(0, 80, 101, 23))
        icon2 = QtGui.QIcon()
        ...
        self.comboBox = QtWidgets.QComboBox(framePrincipal)
        self.comboBox.setGeometry(QtCore.QRect(500, 0, 69, 22))
        ...
        self.buttonCargarImagen.clicked.connect(self.graphicsView.show)
    ...
    def retranslateUi(self, framePrincipal):
        ...
        self.Eliminar.setText(_translate("framePrincipal", "Eliminar imagen"))
        ...
        self.comboBox.setItemText(0, _translate("framePrincipal", "Acerca de"))
        self.comboBox.setItemText(1, _translate("framePrincipal", "Creditos"))
        self.comboBox.setItemText(2, _translate("framePrincipal", "Salir"))

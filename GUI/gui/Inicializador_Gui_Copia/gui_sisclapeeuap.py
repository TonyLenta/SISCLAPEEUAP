...
class Ui_framePrincipal(object):
    def setupUi(self, framePrincipal):
        ...
        self.buttonPredecir = QtWidgets.QPushButton(self.groupBoxClasificador)
        self.buttonPredecir.setGeometry(QtCore.QRect(30, 20, 291, 23))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setBold(True)
        font.setWeight(75)
        self.buttonPredecir.setFont(font)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../../iconos/predecir.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonPredecir.setIcon(icon3)
    ...
    def retranslateUi(self, framePrincipal):
        ...
        self.buttonPredecir.setText(_translate("framePrincipal", "Predecir"))
